        ...
        content: SingleChildScrollView( // Thêm scroll cho nội dung dài
          child: Column(
            ...
            children: [
              ...
              Text(
                '${tr('Common.CurrentVersion')}: ${updateResult.currentVersion ?? tr('Common.Unknown')}',
                style: const TextStyle(fontSize: 12),
              ),
              Text(
                '${tr('Common.NewVersion')}: ${updateResult.version ?? tr('Common.Unknown')}',
                style: const TextStyle(fontSize: 12),
              ),
            ],
          ),
        ...
        actions: [
          ...
          if (updateResult.updateAvailable && updateResult.downloadUrl != null)
            ElevatedButton(
              ...
              onPressed: () async {
                if (await canLaunchUrl(Uri.parse(updateResult.downloadUrl!))) {
