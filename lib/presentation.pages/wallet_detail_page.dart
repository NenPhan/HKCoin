                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            context.tr(
                                              "Account.Wallet.Detail.CreateBy",
                                            ),
                                          ),
                                          Text(
                                            controller
                                      ...
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text(context.tr('Common.CreatedOn')),
                                          Text(
                                            dateFormat(
                                              controller
                                                  .walletsInfo
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        onTap: () {
                                          if (controller
                                                  .walletsInfo
                                                  ?.createWalletTypeId ==
                                              CreateWalletType.Mnemonic.index) {
                                            Get.toNamed(
                                              WalletDetailBackupPage.route,
                                              arguments: WalletDetailPageParam(
                                            ...
                                            ConfirmDialog.show(
                                              ...
                                              content:
                                                  'Account.Wallet.Detail.Confirm.Content',
                                              okText: 'Common.OK',
                                              cancelText: 'Common.Cancel',
                                              icon:
                                                  Icons
                                                      .info_outline, // Add icon
                                              iconBorderColor: Colors.red,
                                              iconSize: 64,
                                              onOkPressed: () async {
                                                try {
                                                  await Get.toNamed(
                                                    WalletExportPrivateKeyPage
                                                        .route,
                                                    arguments:
                                                        ExportPrivateKeyPageParam(
                                                          wallet:
                                                              controller
                                                                  .walletsInfo!,
                                                        ),
                                      ...
                                      GestureDetector(
                                        ...
                                        onTap: () {
                                          ScreenPopup(
                                            title:
                                                "Account.Wallet.Detail.CopyPublicKey",
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                Text(
                                                  context.tr(
                                                    "Account.Wallet.Detail.Export.PublicKey",
                                                  ),
                                                ),
                                                    ...
                                                    showDialog(
                                                      ...
                                                      builder:
                                                          (
                                                            ...
                                                            content: Text(
                                                              context.tr(
                                                                "Account.Wallet.Detail.Alert.Content",
                                                              ),
                                                            ),
                                                            actions: [
                                                              TextButton(
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              context.tr(
                                                "Account.Wallet.Detail.Export.PrivateKey",
                                              ),
                                            ),
                                            const SizedBox(width: 4),
                                            const Icon(
