...
class WithdrawalrequestHistoryPage extends StatefulWidget {
  ...
  @override
  State<WithdrawalrequestHistoryPage> createState() =>
      _WithdrawalrequestHistoryPageState();
}

class _WithdrawalrequestHistoryPageState
    extends State<WithdrawalrequestHistoryPage> {
                          ...
                          child: DataTable(
                            ...
                            columns: List.generate(
                              ...
                              (index) {
                                return DataColumn(
                                  label: Text(
                                    context.tr(controller.listColumn[index]),
                                    style: textTheme(
                                      context,
                                    ).bodyMedium?.copyWith(
                                      color: Colors.white,
                                    ...
                                    .map(
                                      (histories) => DataRow(
                                        cells: [
                                          ...
                                          _buildDataCell(
                                            text:
                                                histories.amountSwap
                                                    ?.toString() ??
                                                '-',
                                          ),
                                          _buildDataCell(
                                            text:
                                                histories.withDrawalSwap ?? '-',
                                          ),
                                          _buildDataCell(
                                            widget: Container(
                                              padding:
