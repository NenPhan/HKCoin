...
class _WithDrawRequestPagePageState extends State<WithDrawRequestPage> 
  with SingleTickerProviderStateMixin {
    final WithDrawalRequestController controller = Get.put(WithDrawalRequestController());
            ...
            body: SafeArea(
              child: Column(
                children: [
                            ...
                            Expanded(
                              child: SpacingColumn(
                                ...
                                children: [
                                  ...
                                  Text(
                                    controller.walletInfo?.walletShopping ?? "N/A",
                                    style: theme.textTheme.titleLarge?.copyWith(
                                      fontSize: size.width * 0.05,
                                  ...
                                  Text(
                                    controller.walletInfo?.profitsShopping ?? "N/A",
                                    style: theme.textTheme.titleLarge?.copyWith(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          label: Text(tr("Account.WithDrawalRequest.Title")), // Replace with your localized text
                          style: ElevatedButton.styleFrom(
                            padding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 12.0),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10),
                  ...
                  const Expanded(
                    child: WithdrawalrequestHistoryPage(),
                  ),
                ],
              ),
            ),
